...
@WebServlet(name = "FirstHttpServlet/product", urlPatterns = "/first-http-servlet/product")
public class HTTPServletProduct extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println("<h1>Заголовок Товар</h1>");
