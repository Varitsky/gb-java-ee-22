...
@WebServlet(name = "FirstHttpServlet/order", urlPatterns = "/first-http-servlet/order")
public class HTTPServletOrder extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println("<h1>Заголовок Заказ</h1>");
