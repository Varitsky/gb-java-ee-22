...
@WebServlet(name = "FirstHttpServlet/catalog", urlPatterns = "/first-http-servlet/catalog")
public class HTTPServletCatalog extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().println("<h1>Заголовок Каталог/Товары</h1>");
